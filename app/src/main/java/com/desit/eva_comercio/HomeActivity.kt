...
class HomeActivity : AppCompatActivity() {
    ...
    fun onCategoriaSeleccionada(event:CategoriaClick)
    {
        if (event.isSuccess)
        {
            //Toast.makeText(this,"seleccionaste "+ event.categoria.name,Toast.LENGTH_SHORT).show()
    ...
    @Subscribe(sticky = true,threadMode = ThreadMode.MAIN)
    fun onFoodSelect(event: ComidaClick)
    {
        if (event.isSuccess)
        {
            //Toast.makeText(this,"seleccionaste "+ event.categoria.name,Toast.LENGTH_SHORT).show()
